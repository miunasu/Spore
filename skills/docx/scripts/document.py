...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "You", initials: str = "Y"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "You")
            initials: Author initials (default: "Y")
        """
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "You")
